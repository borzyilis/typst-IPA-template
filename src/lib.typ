...
#let project(
  ...
  import "@preview/glossarium:0.4.1": (
    make-glossary as make-list-of-abbreviations,
    print-glossary as print-list-of-abbreviations,
  )
  ...
  if show-list-of-abbreviations and is-not-none-or-empty(list-of-abbreviations) {
    if is-not-none-or-empty(list-of-abbreviations.at(0).key) and is-not-none-or-empty(list-of-abbreviations
      .at(0)
      .short) {
      page(numbering: "I")[
  ...
  // List of Formulas
  set math.equation(
    numbering: if thesis-compliant or show-list-of-formulas { "(1)" } else { none },
  ...
  // Body
  set page(footer: if thesis-compliant == false [
